...
const getDaysOfDifference = () => {
  const startDate = new Date("11/21/2022");
...
async function circulatingSupply() {
  let currentTotalSupply = 13510792543;
  const dailyInflation = 8933333;

  currentTotalSupply += getDaysOfDifference() * dailyInflation;
